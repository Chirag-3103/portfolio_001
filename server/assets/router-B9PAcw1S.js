...
const appCss = "/portfolio_001/assets/styles-bddPQZJv.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "A premium, minimal personal portfolio website showcasing frontend development and web design skills with interactive elements." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "A premium, minimal personal portfolio website showcasing frontend development and web design skills with interactive elements." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "A premium, minimal personal portfolio website showcasing frontend development and web design skills with interactive elements." }
    ],
    links: [
...
const $$splitComponentImporter = () => import("./index-gE4iYN4j.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Chirag Kumar — Frontend Developer"
    }, {
      property: "og:description",
      content: "Craft over hype. Build with purpose. Code like a weapon."
    }, {
      property: "og:type",
      content: "website"
    }],
