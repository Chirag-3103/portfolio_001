...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C1wtYaun.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-B9PAcw1S.js").then((n2) => n2.a),
    import("./start-46IyCdGw.js"),
...
var ROUTER_BASEPATH = "portfolio_001";
var SERVER_FN_BASE = "/portfolio_001/_serverFn/";
